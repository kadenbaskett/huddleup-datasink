...
class DatabaseService {
  ...
  public async updatePlayerProjections(projections) {
    try {
      await this.client.playerProjections.upsert({
        where: {
          external_game_id_external_player_id: {
            external_game_id: projections.external_game_id,
            external_player_id: projections.external_player_id,
          },
        },
        update: {
          external_game_id: projections.external_game_id,
          external_player_id: projections.external_player_id,
          pass_yards: projections.pass_yards,
          pass_attempts: projections.pass_attempts,
          completions: projections.completions,
          pass_td: projections.pass_td,
          interceptions_thrown: projections.interceptions_thrown,
          receptions: projections.receptions,
          rec_yards: projections.rec_yards,
          targets: projections.targets,
          rush_attempts: projections.rush_attempts,
          rush_yards: projections.rush_yards,
          rush_td: projections.rush_td,
          two_point_conversion_passes: projections.two_point_conversion_passes,
          two_point_conversion_runs: projections.two_point_conversion_runs,
          two_point_conversion_receptions: projections.two_point_conversion_runs,
          player_id: projections.player_id,
          team_id: projections.team_id,
        ...
        create: {
          ...
          pass_td: projections.pass_td,
          interceptions_thrown: projections.interceptions_thrown,
          fumbles: projections.fumbles,
          receptions: projections.receptions,
          rec_td: projections.rec_td,
          rec_yards: projections.rec_yards,
          targets: projections.targets,
          rush_attempts: projections.rush_attempts,
          rush_yards: projections.rush_yards,
